...
import face1 from '../../static/images/faces/face1.jpg';
import face2 from '../../static/images/faces/face2.jpg';
                    ...
                    <div className="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul className="chat-list">
                            <li className="list active">
                                <div className="profile"><img src={face1} alt="image" /><span
                            ...
                            <li className="list">
                                <div className="profile"><img src={face2} alt="image"/><span
